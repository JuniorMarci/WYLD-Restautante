 ...
 <!-- MENU -->
    ...
    <!-- Removed bebida and cocktail options -->
            ...
            <form action="salvar_bar.php" method="post" onsubmit="return guardarPlato();">
...
$jsonData = file_get_contents('bar.json');
    ...
    <table id="tablaMenu">
        ...
        <tbody>
            ...
            <form method="POST" action="remover.php">
                ...
                <input type="hidden" name="file" value="bar.json">
                <input type="hidden" name="redirect" value="bar.php">
